...
class PlatformResourceController extends Controller
{
    ...
    private function authorizeModule(Request $request, string $module): void
    {
        ...
        $permission = match (true) {
            ...
            str_contains($module, 'security') || str_contains($module, 'audit') || str_contains($module, 'api_client') || str_contains($module, 'webhook') => 'security.manage',
            str_contains($module, 'report') || str_contains($module, 'analytics') || $module === 'api_usage_records' => 'reports.view',
            str_contains($module, 'wallet') || str_contains($module, 'settlement') || str_contains($module, 'payment') || in_array($module, ['refunds', 'commissions', 'reconciliations', 'chargebacks', 'fraud_alerts', 'corporate_invoices', 'cost_centres', 'gift_cards', 'vouchers', 'financial_ledger_entries', 'receipts', 'integration_logs'], true) => 'finance.manage',
